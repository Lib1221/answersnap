...
Backend engineer with 5 years of professional Python and Django experience building payment and data APIs.

## Experience

Senior Backend Engineer, Ledgerly (fintech), 2022-03 to present, remote
...
Backend Engineer, Brightpath Analytics, 2021-09 to 2022-02, Lisbon

- Wrote ETL pipelines in Python and pandas that feed the customer dashboards.
- Maintained Flask microservices for data export.
- Tech: Python, Flask, pandas, PostgreSQL, Docker

Volunteer Mentor, Data Science for Everyone (nonprofit), 2021 to present
...
BSc Computer Science, University of Porto, 2015 to 2019
